...
#define _________________DVORAK_L1_________________       KC_Q,    KC_W,    KC_E,    KC_R,    KC_T
#define _________________DVORAK_L2_________________       KC_A,    KC_S,    KC_D,    KC_F,    KC_G
#define _________________DVORAK_L3_________________       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B

#define _________________DVORAK_R1_________________       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P
#define _________________DVORAK_R2_________________       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN
#define _________________DVORAK_R3_________________       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_MINS
